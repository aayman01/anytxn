...
// const Finance = () => {
//     return (
//       <section className="max-w-6xl mx-auto px-8 lg:px-4 pt-16 lg:pt-38">
//         <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-[15px] relative">
//           {/* Top Section */}
//           <div className="order-1 md:col-span-1 space-y-6 md:space-y-8 text-center md:text-left">
//             <h2 className="text-[#1F80F0] font-bold text-xs tracking-[.2rem] mb-4">
//               POWERING THE FUTURE OF FINANCE
//             </h2>
//             <h1 className="text-[#0A2A4A] text-[40px] md:text-[56px] leading-[110%] font-medium">
//               Uncovering new ways to delight customers
//             </h1>
//           </div>

//           {/* Image Section */}
//           <div className="order-2 md:row-span-2 md:col-start-2 flex justify-center items-center">
//             <ImageSection />
//           </div>

//           {/* Bottom Text Section */}
//           <div className="order-3 md:col-span-1 space-y-6 md:space-y-8 text-center md:text-left">
//             <p className="text-[#0A2A4A] text-[14px] md:text-[15px] leading-[170%] font-medium">
//               <strong>
...
//               </strong>
//             </p>
//             <p className="text-[#0A2A4A] text-[14px] md:text-[15px] leading-[160%] font-medium">
