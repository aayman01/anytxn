      ...
      >
        <g id="hero-background-desktop">
          <g
            ...
            style={{
              transform:
                "translate3d(-0.496094%, 1.18182%, 0px), --motion-translateX: 0px, --motion-translateY: 0px, opacity: 1, transition: transform 500ms cubic-bezier(0.25, 0.46, 0.45, 0.94);",
            }}
          >
          ...
          <g
            ...
            style={{
              transform:
                "translate3d(0.297656%, -0.709091%, 0px), --motion-translateX: 0px, --motion-translateY: 0px, opacity: 1; transition: transform 500ms cubic-bezier(0.25, 0.46, 0.45, 0.94);",
            }}
          >
            <path
              id="Vector_13"
